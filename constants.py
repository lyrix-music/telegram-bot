...
REGISTER_INTRO_MESSAGE = "Click the button below to create an account with Lyrix." \
                         "Do not share this link with anyone 😄"

LOGIN_INTRO_MESSAGE = "For those who do not have a lyrix account yet, you should 'register' " \
